package com.example.kickboardguard.Question;
...
import com.example.kickboardguard.SliderScreen.Session;
...
public class WelcomeActivity1 extends AppCompatActivity {
    ...
    private void launchHomeScreen() {
        startActivity(new Intent(WelcomeActivity1.this, SettingActivity.class));
        finish();
    }
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                btnNext.setText(getString(R.string.back));
